...
/* Use jQuery's Autocomplete library to make the Customer Name field an autocomplete box */
 $(function() {
  document.getElementById("adjustType").selectedIndex=0;
customerList = [
...
$( "#c_name" ).autocomplete({
  ...
  focus: function(e, ui) {
	...
	/* Make the type field show/hide the check #/other description box */
...
function AdjustType() {
  var sel=document.getElementById("adjustType").selectedIndex;

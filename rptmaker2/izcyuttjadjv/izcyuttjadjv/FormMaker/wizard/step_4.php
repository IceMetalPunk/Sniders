...
$temp_desc = $desc;
$desc = array();
@$result = query('SHOW COLUMNS FROM `'.$table.'` WHERE Field IN('.$SQL_IN_FORMAT_FIELDS.')');
	...
	<tr>
		<td align="center" width="64" style="background-repeat: y" valign="top" background="images/leftadd.jpg">
			...
			<table border="0" width="100%" id="table8" height="331">
				<tr>
					<td height="18" colspan="2" class="step_title">Settings <a href="" onMouseOver="stm(Step_4[0],Style);" onClick="return false;" onMouseOut="htm()"> <img src="images/Help.png" border="0"></a></td>
				</tr>
				<tr>

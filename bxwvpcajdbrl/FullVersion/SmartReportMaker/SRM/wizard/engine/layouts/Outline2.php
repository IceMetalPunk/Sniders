...

{
...

   {
    ...
    echo   "border='1' cellspacing='0' cellpadding='2' bordercolor='#cccccc' align='center'>";

    }

     echo"<tr><td $span  height='15'  class='TableHeader'></td>
